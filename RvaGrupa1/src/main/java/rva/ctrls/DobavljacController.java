...
public class DobavljacController {
	    ...
	    public ResponseEntity<Dobavljac> getOne(@PathVariable("id") long id) {
	    ...
	    public ResponseEntity<Dobavljac> updateDobavljac(@RequestBody Dobavljac dobavljac, @PathVariable("id") long id) {
